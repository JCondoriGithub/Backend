...
CREATE TABLE `partecipazione` (
  ...
  CONSTRAINT `Impiegato` FOREIGN KEY (`Impiegato`) REFERENCES `impiegato` (`Matricola`),
  CONSTRAINT `Progetto` FOREIGN KEY (`Progetto`) REFERENCES `progetto` (`Sigla`)
...
INSERT INTO `partecipazione` VALUES (101,'Alpha'),(103,'Alpha'),(101,'Beta'),(103,'Beta'),(201,'Beta'),(202,'Beta');
