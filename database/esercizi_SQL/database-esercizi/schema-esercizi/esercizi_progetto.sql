...
CREATE TABLE `progetto` (
  ...
  CONSTRAINT `Responsabile` FOREIGN KEY (`Responsabile`) REFERENCES `impiegato` (`Matricola`)
...
INSERT INTO `progetto` VALUES ('Alpha','Vendite',30,202),('Beta','Inventario',50,301),('Gamma','Distribuzione',18,301);
